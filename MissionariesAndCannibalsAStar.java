...
public class MissionariesAndCannibalsAStar {
    ...
    static List<State> aStarSearch(State initialState) {
        PriorityQueue<State> queue = new PriorityQueue<>(Comparator.comparingInt(o -> heuristic(o) + pathCost(o)));
    ...
    static int pathCost(State state) {
        // In the Missionaries and Cannibals problem, the cost of each move is uniform
        return 1;
    }
