...
public class MissionariesAndCannibalsGBFS {
    ...
    // Perform Greedy Best-First Search (GBFS)
    static List<State> greedyBestFirstSearch(State initialState) {
        PriorityQueue<State> queue = new PriorityQueue<>(Comparator.comparingInt(MissionariesAndCannibalsGBFS::heuristic));
    ...
    public static void main(String[] args) {
        ...
        List<State> path = greedyBestFirstSearch(initialState);
